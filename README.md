<div align="center">
  ...
  <p> **CHASM** (Cavity Response to High-frequency gravitational waves from Astrophysical Source Mergers)\
computes the time evolution of electromagnetic cavity modes driven by the effective Gertsenshtein current generated by primordial black hole (PBH) mergers or early inspiral signals. The repo also contains tools to compute **GW–cavity coupling coefficients**. </p>
</div>
