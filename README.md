<div align="center">
  <img src="logos/logo_simple_CGPT.png" alt="CHASM logo" width="400">
  <h1>CHASM — Cavity Response Simulator</h1>
  <p>
    <b>CHASM</b> (Cavity Response to High-frequency gravitational waves from Astrophysical Source Mergers)
    computes the time evolution of electromagnetic cavity modes driven by the effective Gertsenshtein current
    generated by primordial black hole (PBH) mergers or early inspiral signals.
    The repo also contains tools to compute <b>GW–cavity coupling coefficients</b>.
  </p>
</div>
